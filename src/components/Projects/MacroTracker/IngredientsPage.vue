...
<template>
  <template v-for="(ingredientModal, index) in ingredientModalInformation" :key="index">
    <FormulateIngredient
      :formulate_type="ingredientModal.formulate_type"
  ...
  <section class="card">
    <div class="card-header">
      ...
      <div class="d-flex flex-wrap">
        ...
        <button
          type="button"
          class="m-2 btn-success btn btn-lg"
    ...
    <div class="card-body">
      ...
      <template v-else>
        <div class="ingredientsList">
          <div
            v-for="(ingredientChunk, index) in list_of_ingredients"
            :key="index"
            style="width: 100%"
          >
            <CAccordion flush>
              <CAccordionItem
                v-for="ingredient in ingredientChunk"
                ...
                <CAccordionBody>
                  ...
                  <div class="d-flex btn-group mt-2">
                    <button
                      type="button"
                      class="btn btn-info"
                      @click="handleEditEvent(ingredient)"
                      data-bs-toggle="modal"
