  ...
  <section class="card" id="meals_for_given_date">
    ...
    <div class="card-body">
      ...
      <template v-else v-for="(date, index) in Object.keys(meals_for_time_of_day)" :key="index">
        ...
        <div
          v-if="!(meals_for_time_of_day as Meals_for_time_of_day)[date].zero_meals_to_show"
          class="d-flex flex-wrap"
        >
          <div
            v-for="(meals_for_given_time, meal_time) in (
          ...
          >
            <ul v-if="meals_for_given_time.length > 0" class="list-group m-3">
              ...
              <li
                ...
                v-for="(item, index) in meals_for_given_time"
                :key="index"
