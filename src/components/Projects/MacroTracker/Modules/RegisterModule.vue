...
const _arr: User_input_field[] = reactive([
    { inputType: 'text', placeholder: '', validate_type: 'Username', identifier: 'username', class: 'input-group', attachment: 'Username:', type: 'prepend' },
    { inputType: 'password', placeholder: 'Password', validate_type: 'Password', identifier: 'password', class: 'form-group' },
    { inputType: 'password', placeholder: 'Repeat Password', validate_type: 'Password', identifier: 'confirm_password', class: 'form-group' },
    { inputType: 'text', placeholder: '', validate_type: 'Name', identifier: 'name', class: 'input-group', attachment: 'Name:', type: 'prepend' },
    { inputType: 'email', placeholder: '', validate_type: 'Email', identifier: 'email', class: 'input-group', attachment: '@ Email:', type: 'prepend' },
...
<template>
    ...
    <div class="input-group mt-2">
        <select
            @change="user_validation_arr.gender = validateGenderOrActivityLvl($event, validation_messages.register.gender.value, 'Gender', 'form-control form-control-md')"
    ...
    <div class="form-group mt-2">
        <select
            @change="user_validation_arr.activityLvl = validateGenderOrActivityLvl($event, validation_messages.register.activity_lvl.value, 'Activity Lvl', 'form-control form-control-md')"
