  ...
  <CAccordionBody>
    <div class="d-flex flex-column">
      <div class="description">
        ...
        <RouterLink v-if="project.routerLink" :to="project.routerLink">
          <p>Go to {{ project.name }}</p>
        </RouterLink>

        <a v-if="project.githubLink" :href="project.githubLink"> Github repository </a>
      </div>

      <img
        v-if="project.imageLink"
        class="project_img"
