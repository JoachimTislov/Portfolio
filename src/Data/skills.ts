...
export const skills: skills = {
    'Visual Studio': {name: 'Visual Studio', icon: ['fas', 'code'], link: 'https://code.visualstudio.com/'},
    ...
    'CSS': {name: 'CSS', icon: ['fab', 'css3'], link: 'https://developer.mozilla.org/en-US/docs/Web/CSS'},
    'HTML': {name: 'HTML', icon: ['fab', 'html5'], link: 'https://developer.mozilla.org/en-US/docs/Web/HTML'},
    'Javascript': {name: 'Javascript', icon: ['fab', 'js'], link: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript'},
    'Typescript': {name: 'Typescript', icon: null, link: 'https://www.typescriptlang.org/'},
    'Vue FrameWork': {name: 'Vue FrameWork', icon: ['fab', 'vuejs'], link: 'https://vuejs.org/guide/introduction.html'},
